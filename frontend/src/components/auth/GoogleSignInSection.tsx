...
function GoogleMark() {
  return (
    <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true">
      ...
      <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-1.1 3.2-3.5 5.8-6.5 7.4l6.2 5.2C37.3 38.3 44 34 44 24c0-1.2-.1-2.3-.4-3.5z" />
    </svg>
  );
}
    ...
    <>
      ...
      {configured ? (
        ...
        <button
          ...
          disabled
          title="Set GOOGLE_AUTH_CLIENT_ID to enable Google sign-in."
        >
          <GoogleMark />
